...
<%-- ${test.ordernum} --%>
<%-- 	<c:forEach var="test2" items="${test.orderdetail}">  --%>
<%-- 	<c:set var = "total" value = "0" /> --%>
<%-- 	<c:set var= "total" value="${total + test2.price}"/> --%>
...
<%-- <c:forEach var="test" items="${orderList}"> --%>
<%-- ${test.ordernum} --%>
<%-- 	<c:forEach var="test2" items="${test.orderdetail}"> --%>
<%-- 	${test2} --%>
<%-- 	</c:forEach> --%>
<%-- ${test.member.userid}<br> --%>
<%-- ${test.orderdetail.price} --%>
<%-- </c:forEach> --%>
<%-- ${test} --%>
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
<!--
                                                ...
                                                <div id="layer_bg">
                                                    <div id="popup">
                                                        <h4>
                                                            My Review
                                                            <label for="layerPopup" class="fa fa-xmark" style="margin-left: 130px"></label>
                                                        </h4>
                                                        <br>
                                                        컨텐츠 영역입니다.
                                                    </div>
