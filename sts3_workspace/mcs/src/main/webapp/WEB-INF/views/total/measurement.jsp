...
<head>
	...
	var chart = new Chart(ctx, {
		...
		backgroundColor: [ 'rgba(70, 163, 196, 0.5)', 'rgba(158, 194, 228, 0.5)', 'rgba(197, 107, 171, 0.5)', 'rgba(246, 154, 193, 0.5)',
			...
			'rgba(131, 193, 92, 0.5)','rgba(159, 213, 189, 0.5)','rgba(251, 184, 95, 0.5)','rgba(255, 227, 162, 0.5)'], //그래프 올라가는거 색깔
		...
		fontSize: 30, fontColor: 'rgba(42, 63, 84, 1)' }, //title 칼럼
		legend: { labels: { fontColor: 'rgba(83, 51, 237, 1)', // 아래 피부타입 색
		fontSize: 15 } },
		scales: {
			xAxes: [{
				ticks: { fontColor: 'rgba(27, 163, 156, 1)', fontSize: '15' } }],
				yAxes: [{ ticks: { beginAtZero: true, fontColor: 'rgba(42, 63, 84, 1)', fontSize: '15' } }] } } }); //y출 컬럼
        ...
        <div class="sideArea">
            ...
            <ul class="sideMenu">
                ...
                <li><a href="javascript:undefined" class="has-submenu"><span class="fa fa-spray-can-sparkles"></span>제품관리</a>
                    <ul class="submenu">
                        <li><a href=""><span class="fa fa-magnifying-glass"></span>제품정보</a></li>
                        <li><a href=""><span class="fa fa-magnifying-glass"></span>원료정보</a></li>
                ...
                <li><a href="javascript:undefined" class="has-submenu"><span class="fa fa-line-chart"></span>통계관리</a>
                    <ul class="submenu" style="display: block;">
                        <li><a href="" style="background: rgba(255,255,255,0.5);"><span class="fa fa-users"></span>고객통계</a></li>
                        <li><a href=""><span class="fa fa-pencil"></span>평가통계</a></li>
