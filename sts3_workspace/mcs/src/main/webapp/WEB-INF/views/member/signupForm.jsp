...
/* 	/*
		...
		function formCheck() {
			...
			if (!checkBirth.test(_birth.value)) {
				alert("8자리 생년월일을 숫자만 입력해주세요. (예)YYYYMMDD");
				return false;
			}
			*/
			if (_pw_find.value == "") {
			...
			<div class="tab-pane" id="tab3">
				<div>
					<form action="signup" method="post">
						...
						<span> <label>아이디 </label><input type="text" id="_username" name="username" minlength="6" maxlength="20" placeholder="영문+숫자, 6~20자" />
						...
						<input type="text" id="addr" placeholder="주소를 입력해주세요." style="width: 400px;">
							<label for="address2" style="width: 80px;"></label> 
							<input type="text" id="addr2" placeholder="상세 주소를 입력해주세요." style="width: 400px;"></span>
