            ...
            <ul class="sideMenu">
                ...
                <li><a href="javascript:undefined" class="has-submenu"><span class="fa fa-spray-can-sparkles"></span>제품관리</a>
                    <ul class="submenu" style="display: block;">
                        <li><a href="/compProductList" style="background: rgba(255,255,255,0.5);"><span class="fa fa-magnifying-glass"></span>제품정보</a></li>
                        <li><a href="/compProductIngredients"><span class="fa fa-magnifying-glass"></span>원료정보</a></li>
                        <li><a href=""><span class="fa fa-question"></span>제품문의관리</a></li>                        
                    </ul>
                </li>
                <li><a href="javascript:undefined" class="has-submenu"><span class="fa fa-store"></span>주문관리</a>
                    <ul class="submenu">
                        <li><a href=""><span class="fa fa-magnifying-glass"></span>주문정보</a></li>
                        <li><a href=""><span class="fa fa-magnifying-glass"></span>취소정보</a></li>
                    </ul>
                </li>
                ...
                <li><a href="javascript:undefined" class="has-submenu"><span class="fa fa-line-chart"></span>통계관리</a>
                    <ul class="submenu">
                        <li><a href=""><span class="fa fa-users"></span>고객통계</a></li>
                        <li><a href="/totalAccount"><span class="fa fa-pencil"></span>평가통계</a></li>
                        <li><a href=""><span class="fa fa-vial"></span>원료통계</a></li>
                    </ul>
                </li>
...
-->
                        ...
                        <a href="/addproductForm" class="btnAdd fa fa-plus bg-1 text-fff"></a>                        
                    </div>
                </div>
                    ...
                    <div class="table" style="min-width: 1600px">
                        ...
                        <ul>
                            <li class="row">
                                ...
                                <div class="cell cell-100">
                                    <a href="/compProductUpdate?pronum=${product.pronum}" class="btnEdit fa fa-pencil bg-1 text-fff"></a><a href="/deleteProduct?pronum=${product.pronum}" class="btnRemove fa fa-remove bg-1 text-fff" onclick='return confirm("Do you really want to remove it ?")'></a>
                                </div>
                            </li>
                        </ul>
                        </c:forEach>
