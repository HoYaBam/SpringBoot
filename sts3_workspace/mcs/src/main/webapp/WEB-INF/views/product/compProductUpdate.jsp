    ...
    <div class="container">
        ...
        <div class="mainArea">
            ...
            <div class="mainContent">
                ...
                <!-- DETAIL FORM -->
                <form action="/updateProduct" method="POST" enctype="multipart/form-data" class="form">
                    <div class="formHeader row">
                        <h2 class="text-1 fl">Product Detail</h2>
                        <div class="fr">
                            <input type="button" class="btnSave bg-1 text-fff text-bold fr" onclick="attach(form)">SAVE</button>
                        </div>
                    </div>
