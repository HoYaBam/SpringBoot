            ...
            <ul class="sideMenu">
                ...
                <li><a href="javascript:undefined" class="has-submenu"><span class="fa fa-spray-can-sparkles"></span>제품관리</a>
                    <ul class="submenu" style="display: block;">
                        <li><a href="/compProductList"><span class="fa fa-magnifying-glass"></span>제품정보</a></li>
                        <li><a href="/compProductIngredients" style="background: rgba(255,255,255,0.5);"><span class="fa fa-magnifying-glass"></span>원료정보</a></li>
