...
<body>
    <header>
        <div><img src="image/mcs.png"></div>
        <section>
            <img src="https://image.flaticon.com/icons/svg/102/102665.svg">
            <img src="https://image.flaticon.com/icons/svg/747/747376.svg">
    ...
    <section class="card">
        <main>
            <div class="nav">
                <div class="swiper-slide image swiper-slide-active" id="side-img" onclick="works.detail.zoom(this)" data-alt="브라이트닝 필링 2종 세트 (필링젤+필링패드) 썸네일" data-type="image" data-bigger="https://fs.dr-g.co.kr/item/4542/4542-represent.jpg" style="height: 60px; margin-bottom: 10px;">
                    <img src="https://fs.dr-g.co.kr/item/4542/4542-represent.jpg" alt="브라이트닝 필링 2종 세트 (필링젤+필링패드) 썸네일 이미지" class="box-noimg-sm" onerror="this.src='/resources/assets/imgs/util/noimg_3.png'">
                    <div class="swiper-slide image swiper-slide-active" id="side-img" onclick="works.detail.zoom(this)" data-alt="브라이트닝 필링 2종 세트 (필링젤+필링패드) 썸네일" data-type="image" data-bigger="https://fs.dr-g.co.kr/item/4542/4542-represent.jpg" style="height: 60px; margin-bottom: 10px;">
<!--                         <img src="#" alt="브라이트닝 필링 2종 세트 (필링젤+필링패드) 썸네일 이미지" class="box-noimg-sm" onerror="this.src='#'"> -->
                    </div>
                </div>
            </div>
        ...
        <fmt:parseNumber var= "salePrice" integerOnly= "true" value= "${product.price-(product.price*product.sale/100)}"/>
            ...
            <button onclick="moveCart()">장바구니</button>
    ...
    <article class="two">
        <h3>함께 볼 제품 추천</h3>
        <section>
            <div><img src="image/cream/main1.jpg">
                <h5>진정 강한 수분크림 </h5>
                <span class="red">19,000원</span>
            </div>
            <div><img src="image/clean/main1.jpg">
                <h5>깔끔 산뜻 핸드 크림</h5>
                <span class="red">9,000원</span>
            </div>
            <div><img src="image/esseen/main1.jpg">
                <h5>레드 블레미쉬 클리어 수딩 액티브 에센스 80ml</h5>
                <span class="red">34,200원</span>
            </div>
            <div><img src="image/tonor.mist/main1.jpg">
                <h5>레드 블레미쉬 클리어 수딩 토너 200ml</h5>
                <span class="red">23,000원</span>
            </div>
        </section>
    </article>
    <article class="plus">
